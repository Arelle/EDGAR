...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/1999/xhtml" version="1.0">
  ...
  <xsl:variable name="fetchprefix">/ft/view.html?filename=</xsl:variable>
  <xsl:variable name="fetch_ix_prefixquoted"><![CDATA[/ft/view.html?filename=]]></xsl:variable>
  ...
  <xsl:variable name="metaLinksSuffixQuoted" select="'&amp;metalinks=/ft/view.html?filename=MetaLinks.json'" />
